...
# example.com/ansible-example-operator-bundle:$VERSION and example.com/ansible-example-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/ansible-example-operator
